...
@section('title', 'Hasil Pencarian - MEDAL')

@section('content')
<div class="min-h-screen bg-gray-50">
    
    {{-- Sticky Header with Search --}}
    <div class="sticky top-0 z-40 bg-gray-50 pt-6 pb-4 border-b border-gray-200 shadow-sm">
...
<div class="flex justify-between items-center">
    <p class="text-sm text-gray-600">
        Hasil pencarian <span class="font-semibold text-gray-900">"{{ $query }}"</span> 
        <span class="text-gray-500">(data diambil secara real time)</span>
    </p>
    ...
    <div class="max-w-7xl mx-auto px-8 py-8">
        ...
        @php
            ...
            $positifPercent = $total > 0 ? round(($sentimentStats['positif'] / $total) * 100, 1) : 0;
            $negatifPercent = $total > 0 ? round(($sentimentStats['negatif'] / $total) * 100, 1) : 0;
            $netralPercent = $total > 0 ? round(($sentimentStats['netral'] / $total) * 100, 1) : 0;
        @endphp
        ...
        <div class="grid grid-cols-4 gap-4 mb-8">
            ...
            <div class="bg-green-500 rounded-xl p-6 text-white shadow-lg">
                ...
                <div class="mt-2 text-2xl font-bold">{{ $positifPercent }}%</div>
            </div>
            ...
            <div class="bg-red-500 rounded-xl p-6 text-white shadow-lg">
                ...
                <div class="mt-2 text-2xl font-bold">{{ $negatifPercent }}%</div>
            </div>
            ...
            <div class="bg-yellow-500 rounded-xl p-6 text-white shadow-lg">
                ...
                <div class="mt-2 text-2xl font-bold">{{ $netralPercent }}%</div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl shadow-md border border-gray-200 p-6">
                ...
                <div style="height: 300px; position: relative;">
                    <canvas id="searchResultsChart"></canvas>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pb-20">
            ...
            @else
                <div class="col-span-3 text-center py-12">
                    ...
                    <h3 class="mt-4 text-lg font-medium text-gray-900">Tidak ada hasil</h3>
                    <p class="mt-2 text-gray-500">Tidak ditemukan berita untuk "{{ $query }}"</p>
                </div>
            @endif
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    const ctx = document.getElementById('searchResultsChart');
    if (ctx) {
        new Chart(ctx, {
            type: 'bar',
            data: {
...
function saveToHistory() {
    alert('Pencarian berhasil disimpan ke history!');
